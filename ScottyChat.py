...
def text_reply(msg):
    ...
    if msg.user.nickName not in Config.GROUPS or msg.msgId in history:
        return
    try:
        openai.api_key = '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'
        ...
        if len(text.split(' ')) <= 8:
            ...
            file_name = '/Users/sophiazhu/Documents/Workplace/Summer2023_WeChatMessages/image_cache/tmp.png'
            ...
            path = '/Users/sophiazhu/Documents/Workplace/Summer2023_WeChatMessages/image_cache/tmp.png'
